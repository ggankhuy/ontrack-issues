...
for i in sys.argv:
    print("Processing ", i)
    if re.search("--size=", i):
       user_size=int(i.split('=')[1].strip())

if user_size == None:
    print("Err: must supply matrix size for M,N,K (all same)")
    quit(1)
...
def matmul_kernel(
    ...
    #print("GG: matmul_kernel: (M,N,K): ", M,N,K)
...
def matmul(a, b, activation=""):
    #print("")
    #print("=========================================================")
    print("GG: matmul (a.shape, b.shape, activation): ", a.shape, b.shape, activation)
    # Check constraints.
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        x_vals=[
            128 * i for i in range(user_size, user_size + 1)
...
def benchmark(M, N, K, provider):
    #print("GG: benchmark(M,N,K): ", M,N,K)
