...
def main(enable_cudagraph, enable_compile) -> int:
    ...
    if enable_compile:
        model = torch.compile(
            ...
            fullgraph=True,
            options={
                "triton.cudagraphs": enable_cudagraph,
            }
        )
    ...
    # capture
    if enable_cudagraph and not enable_compile:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--enable_compile", default=False, action="store_true")
    args, _ = parser.parse_known_args()
    main(args.enable_cudagraph, args.enable_compile)
